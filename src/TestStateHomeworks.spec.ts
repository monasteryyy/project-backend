...
import { EstadoTareasService, Tarea, historialEstados } from './app.StateHomeworks';
...
beforeEach(() => {
  ...
  // TEST FUNCIONALIDAD 2
    ...
    test('CASO LÍMITE: Debe lanzar error si se intenta cambiar una tarea Finalizada', () => {
    ...
    test('CASO LÍMITE: Debe impedir salto inválido de Creada a Finalizada', () => {
        expect(() => {
  ...
  // TEST FUNCIONALIDAD 3
    ...
    test('CASO LÍMITE: Debe retornar un arreglo vacío si la tarea no tiene historial', () => {
